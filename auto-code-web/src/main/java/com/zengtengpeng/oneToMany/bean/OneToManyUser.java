 ...
 *一对多用户 bean
 */
@ApiModel(description="一对多用户")
public class OneToManyUser   extends Page  {

	/**
	 * 一对多收货地址
	 */
	@ApiModelProperty(hidden = true)
	private List<OneToManyAddr> oneToManyAddrList;
	 ...
	 * 一对多收货地址
	 */
	public List<OneToManyAddr> getOneToManyAddrList(){
		return oneToManyAddrList;
	}
	 ...
	 * 一对多收货地址
	 */
	public void setOneToManyAddrList(List<OneToManyAddr> oneToManyAddrList){
		this.oneToManyAddrList = oneToManyAddrList;
	}
